...
INSERT [dbo].[FormMaster] ([FormTypeId], [Name], [Path], [DisplayOrder], [ReadAccess], [WriteAccess], [SpecialReadAccess], [SpecialWriteAccess], [IsDeleted], [CreatedBy], [CreatedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'Reserve Book', N'/Book/Reserve', 2, N'0', N'0', NULL, NULL, 0, 1, GetDate(), 1, GetDate())
...
INSERT [dbo].[FormMaster] ([FormTypeId], [Name], [Path], [DisplayOrder], [ReadAccess], [WriteAccess], [SpecialReadAccess], [SpecialWriteAccess], [IsDeleted], [CreatedBy], [CreatedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Pending Fine', N'/Fine/Pending', 1, N'0', N'0', NULL, NULL, 0, 1, GetDate(), 1, GetDate())
INSERT [dbo].[FormMaster] ([FormTypeId], [Name], [Path], [DisplayOrder], [ReadAccess], [WriteAccess], [SpecialReadAccess], [SpecialWriteAccess], [IsDeleted], [CreatedBy], [CreatedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Fine History', N'/Fine/History', 2, N'0', N'0', NULL, NULL, 0, 1, GetDate(), 1, GetDate())
